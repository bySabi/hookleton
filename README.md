...
[page](https://yvjkpvn95v.sse.codesandbox.io/counter) [source]()
...
Examples [page](https://yvjkpvn95v.sse.codesandbox.io/) and [codesandbox](https://codesandbox.io/s/yvjkpvn95v), include:

- _Todo App_ [page](https://yvjkpvn95v.sse.codesandbox.io/todo) [source]()
- a _Mouse_ event listener that notify `{x,y}` position to 600 components in Real Time [page](https://ox615lq106.sse.codesandbox.io/mouse) [source]()
- basic _Counter_ showed above [page](https://yvjkpvn95v.sse.codesandbox.io/counter) [source]()
- 5 counters in 25 components. Include a basic `global store` [page](https://yvjkpvn95v.sse.codesandbox.io/counters5x5) [source]()
- 5 counters in 400 components. Default non-blocking renderer [page](https://yvjkpvn95v.sse.codesandbox.io/counters10x40) [source]()
- 5 counters in 400 components. With a custom blocking renderer [page](https://yvjkpvn95v.sse.codesandbox.io/counters10x40) [source]()
- showing Fetched 10 random users data in 16 components [page](https://yvjkpvn95v.sse.codesandbox.io/fetch) [source]()
...
Default **createHook** is a _createHookWithClass_ function
